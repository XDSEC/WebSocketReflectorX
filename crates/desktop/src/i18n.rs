...
static TABLE: Lazy<Vec<Entry>> = Lazy::new(|| {
    vec![
        ...
        (
            "This scope is controlled by you manually.",
            "该作用域由你手动控制。",
            "該範圍由你手動控制。",
        ),
        (
            "This domain can control wsrx on your local network.",
            "该域名可以在你的局域网内控制 wsrx。",
            "該網域可以在你的區域網路內控制 wsrx。",
        ),
        (
            "This domain requested controlling wsrx.",
            "该域名请求控制 wsrx。",
            "該網域請求控制 wsrx。",
        ),
        ("No Operation", "无需操作", "无需操作"),
        ("Accept", "接受", "接受"),
        ("Decline", "拒绝", "拒絕"),
        ("Remove", "移除", "移除"),
        ("Click to copy: ", "点击复制: ", "點擊複製: "),
        ...
        ("Export", "导出", "匯出"),
        (
            "Have problems? Find support here.",
            "遇到问题？在这里寻求支持。",
            "遇到問題？在這裡尋求支援。",
        ),
        ("Support", "支持", "支援"),
        ...
        (
            ...
            "上报 Bug 或寻求帮助时，请附上以下信息。",
            "回報 Bug 或尋求幫助時，請附上以下資訊。",
        ),
    ]
});
